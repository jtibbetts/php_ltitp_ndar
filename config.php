...
###
define('APP_NAME', 'SimpleLti');
define('SESSION_NAME', 'php-simple');
define('LTI_FOLDER', 'lti/');

###
###  Database connection settings
###
define('DB_SERVER', 'localhost');  // e.g. 'mysql:dbname=MyDb;host=localhost' or 'sqlite:php-rating.sqlitedb'
define('DB_USER', 'root');
define('DB_PASSWORD', '');
define('DB_NAME', 'lti-ndar');
